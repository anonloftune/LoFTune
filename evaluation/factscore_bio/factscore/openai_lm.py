...
def call_ChatGPT(message, model_name="gpt-4o-mini-2024-07-18", max_len=1024, temp=0.7, verbose=False):
...
def call_GPT3(prompt, model_name="gpt-4o-mini-2024-07-18", max_len=512, temp=0.7, num_log_probs=0, echo=False, verbose=False):
    # call GPT-3 API until result is provided and then return it
    response = None
    received = False
    num_rate_errors = 0
